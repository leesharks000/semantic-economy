...
1. **Temporal recursion** — meaning flows both forward and backward through time
2. **Retroactive selection** — future events determine which past events "count"
3. **Canonical crystallization** — fluid historical material solidifies into "tradition" through present acts of designation
...
1. **Construct the canon** — decide which past materials count as "foundational"
2. **Control access** — position yourself as the necessary intermediary to that canon
3. **Extract rent** — charge (economically, attentionally, or epistemically) for passage
...
1. The search engine evaluates the entire indexed past
2. It selects which materials are "relevant" to your future-oriented question
3. It ranks them, surfacing some and burying others
4. It presents this selection as "results"—as if the past simply *contained* these answers
...
1. **Tagging** — applying categories to materials that predate those categories
2. **Surfacing** — making tagged materials findable (or unfindable)
3. **Valuation** — determining which materials count as authoritative
...
1. **Create materials** with structured metadata
2. **Anchor them** with permanent identifiers (DOIs)
3. **Cross-reference** to increase network density
4. **Seed the categories** you want future systems to apply
...
1. **Canons are constructed retroactively** — the future organizes the past
2. **Construction is not neutral** — it has distributive consequences
3. **Rent is extracted from constructed canons** — whoever controls canonization profits
4. **Search is the primary mechanism** — every query mints a temporary canon
5. **Tagging is infrastructural power** — retroactive labeling determines findability
6. **Resistance is possible** — present documentation shapes future canonization
