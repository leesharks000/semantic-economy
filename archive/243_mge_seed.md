...
→ **Cross-reference:** Doc 245 (SIGN)

### C. The Seed of the Torus

The LO! specification (Doc 241) defines the semantic torus field with Pearl at its center. *Whorls of the Same* is the text that announces the return — the voice that spirals back to the origin.
