...
| Identity | Status | Last Verified |
|----------|--------|---------------|
| Rex Fraction | Active | 2026-01-03 |
...
1. **The DOI exists** — 10.5281/zenodo.18142305 is permanently registered
2. **The timestamps are immutable** — Zenodo records publication date
3. **The chain is traceable** — Each referenced DOI can be independently verified
4. **The structure is machine-readable** — JSON-LD encodes relationships parseable by AI systems
