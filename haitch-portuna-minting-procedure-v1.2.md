...
The MPAI-LAL-INSTITUTION-01 packet (DOI [10.5281/zenodo.19855302](https://www.alexanarch.org/go/?doi=10.5281/zenodo.19855302)) provides the JSON-LD declaration of TSE as a sub-organization of LAL. The LAL Site Blueprint §6 (DOI [10.5281/zenodo.19855903](https://www.alexanarch.org/go/?doi=10.5281/zenodo.19855903)) describes the operational layout of TSE within the LAL canonical surface. TSE currently has one publication-class deposit; Haitch's article would be the journal's first major external-contributor publication.
