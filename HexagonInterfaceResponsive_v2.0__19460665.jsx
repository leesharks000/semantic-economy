  ...
  if (!mode) return (
    <div style={{ height: "100dvh", background: "#0a0d12", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "Georgia,serif", padding: 16 }}>
      <div style={{ textAlign: "center", maxWidth: 540 }}>
        ...
        <div style={{ fontSize: 10, color: "#3a4a3a", marginBottom: 20 }}>{data.rooms.length} rooms · {data.documents.length} indexed · {data.relations.length} relations · <a href="https://www.alexanarch.org/go/?doi=10.5281/zenodo.19013315" target="_blank" rel="noreferrer" style={{ color: "#5a6a4a" }}>Space Ark v4.2.7</a></div>
