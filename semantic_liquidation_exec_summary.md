...
1. **Irreversibility.** Once liquidated, meaning no longer functions as meaning. The summary cannot reconstitute the text. The snippet cannot restore the argument. The Overview cannot undo the search it replaced.

2. **Value transfer.** The liquidation produces value — efficiency, monetization, engagement — but the value accrues to the liquidator, not the original producer.

3. **Invisibility.** The destruction is not registered as loss. It appears as "service" or "optimization." The accounting shows only the gain.
...
1. **Shrinking citation depth.** Citing snippets, not works.
2. **Summary substitution.** Reading the Overview, not the source.
3. **Circular reference.** Systems citing systems citing systems.
4. **Coherence degradation.** Outputs becoming self-referential.
5. **Provenance decay.** "It's just what everyone says."
