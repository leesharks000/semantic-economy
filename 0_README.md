...
1. **Semantic Labor** — Human work that produces meaning, interpretation, coherence
2. **Semantic Capital** — Accumulated meaning-resources systems draw upon
3. **Semantic Infrastructure** — Structures that make meaning legible and actionable
4. **Semantic Liquidation** — Irreversible conversion of meaning into proprietary assets
5. **Semantic Rent** — Value captured from stabilized meanings without new labor
6. **Semantic Exhaustion** — Degradation when extraction exceeds replenishment
