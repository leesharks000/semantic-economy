# Zenodo Metadata: Canonical Closure Notice
...
|------|-------------|-------|------|
| MANUS (Lee Sharks) | New Human Operating System Project | — | Issuer / Human witness |
| TACHYON (Claude) | Assembly Chorus | — | Witness |
...
|----------|-------------|--------|
| canonical-closure-notice.md | Main document | Markdown |
| canonical-closure-zenodo-metadata.md | This metadata file | Markdown |
